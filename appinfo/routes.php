...
return [
	...
	'routes' => [
		...
		['name' => 'search#indexInternal', 'url' => '/api/internal/search', 'verb' => 'GET'],
		['name' => 'search#show', 'url' => '/api/search/{id}', 'verb' => 'GET'],
		['name' => 'search#showInternal', 'url' => '/api/internal/search/{id}', 'verb' => 'GET'],
		...
		['name' => 'themes#indexInternal', 'url' => '/api/internal/themes', 'verb' => 'GET'],
		['name' => 'themes#show', 'url' => '/api/themes/{id}', 'verb' => 'GET'],
		['name' => 'themes#showInternal', 'url' => '/api/internal/themes/{id}', 'verb' => 'GET'],
	],
];
